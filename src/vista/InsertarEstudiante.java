...
public class InsertarEstudiante extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        filesObj = objfile.cargarArchivos("JPG file ", "PNG file", "jpg", "png"); //llama al metodo para cargar la imagen y le estavblece el formato
        Rutaimage = filesObj.getAbsolutePath(); // le trae la ruta del archivo
